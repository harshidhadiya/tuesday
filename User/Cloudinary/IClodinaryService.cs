...

{
    ...
    {
        public  Task<(string? url,string? publicId)> singleUpload(IFormFile file);
        public  Task<List<(string? url,string? publicId)>> multipleUploads(List<IFormFile> files);
        public  Task deleteFile(string publicId);
        

    }
    public class ClodinaryService:IClodinaryService 
    {
