...
namespace USER.Data.Interfaces
{
    ...
    public class SellerLogin : IsellerLogin
    {
        ...
        public async Task<ActionResult> Login(UserLoginDto user, HttpClient? httpClient)
        {
            ...
            await publish.Publish(new RefreshTokenGenerate(userId: existUser.Id, name: existUser.Name, role: existUser.Role, refreshToken: refreshToke, DateTime.UtcNow.AddDays(7)));
